package com.star.cloud.framework.aspect;

import com.star.cloud.framework.annotations.DataBaseSourceTarget;
import com.star.cloud.framework.dynamicdatasource.DataSourceContextHolder;
import com.star.cloud.framework.transactionmanager.DynamicTransactionManagerConfig;
...
public class DataSourceAspect {
	...
	@Before("execution( * com.star.cloud.*.service.*(..)) || @annotation(com.star.cloud.framework.annotations.DataBaseSourceTarget)")
