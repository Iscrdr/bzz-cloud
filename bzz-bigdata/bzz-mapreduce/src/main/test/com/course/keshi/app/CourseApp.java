...
public class CourseApp {
	public static void main(String[] args)  {
		try{
			...
			String inputPath = "D:\\code\\bzz-cloud\\bzz-bigdata\\bzz-mapreduce\\input_jvm";
			String outputPath = "D:\\code\\bzz-cloud\\bzz-bigdata\\bzz-mapreduce\\output2";

			File file = new File("D:\\code\\bzz-cloud\\bzz-bigdata\\bzz-mapreduce\\output2");
			delete(file);
