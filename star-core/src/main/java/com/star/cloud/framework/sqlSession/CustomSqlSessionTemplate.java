package com.star.cloud.framework.sqlSession;
...
import com.star.cloud.framework.DBSource.StarDynamicDataSourceHolder;
...
/**
 * @CLASS_NAME: $
 * @PACKAGE_NAME: com.star.cloud.framework.sqlSession$
 * @Author : yang qian li
 * @Date: 2017-11-24 2:39
 * @Modified by:
 * @Date:
 * @Description:
 */
...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
    ...
    public SqlSessionFactory getSqlSessionFactory() {
        ...
        SqlSessionFactory targetSqlSessionFactory = targetSqlSessionFactorys.get(StarDynamicDataSourceHolder.getDataSourceKey());
